...
var _excluded$h = ["labelRef"], _excluded2$8 = ["content"];
...
function Label(outerProps) {
  ...
  if (typeof content === "function") {
    var {
      content: _2
    } = propsWithViewBox, propsForContent = _objectWithoutProperties$h(propsWithViewBox, _excluded2$8);
...
var _excluded$g = ["valueAccessor"], _excluded2$7 = ["dataKey", "clockWise", "id", "textBreakAll", "zIndex"];
function _extends$i() {
...
function LabelList(_ref2) {
  ...
  var {
    ...
    textBreakAll,
    zIndex
  } = restProps, others = _objectWithoutProperties$g(restProps, _excluded2$7);
...
var _excluded$f = ["points", "className", "baseLinePoints", "connectNulls"];
...
var Polygon = (props) => {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ reactExports.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ reactExports.createElement("path", _extends$h({}, svgPropertiesAndEvents(others), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ reactExports.createElement("path", _extends$h({}, svgPropertiesAndEvents(others), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ reactExports.createElement("path", _extends$h({}, svgPropertiesAndEvents(others), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ reactExports.createElement("path", _extends$h({}, svgPropertiesAndEvents(others), {
...
var _excluded$e = ["children", "type"], _excluded2$6 = ["ref"];
function _extends$f() {
...
var Ticks$1 = (props) => {
  ...
  var _svgPropertiesNoEvent = svgPropertiesNoEvents(props), {
    ref
  } = _svgPropertiesNoEvent, axisProps = _objectWithoutProperties$e(_svgPropertiesNoEvent, _excluded2$6);
...
var selectRadiusAxisWithScale = createSelector([selectRadiusAxisForRadialBar, selectRadiusAxisScaleForRadar], (axis, scale) => {
  ...
  return _objectSpread$b(_objectSpread$b({}, axis), {}, {
    scale
  });
});
...
function RadialBarSectors(_ref2) {
  ...
  return /* @__PURE__ */ reactExports.createElement(RadialBarLabelListProvider, {
    ...
    var radialBarSectorProps = _objectSpread$a(_objectSpread$a(_objectSpread$a(_objectSpread$a({}, baseProps), {}, {
...
class RadialBarWithState extends reactExports.PureComponent {
  renderBackground(sectors) {
    ...
    return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
      ...
      var props = _objectSpread$a(_objectSpread$a(_objectSpread$a(_objectSpread$a(_objectSpread$a({
        cornerRadius: parseCornerRadius(cornerRadius)
      }, rest), {}, {
...
function computeRadialBarDataItems(_ref5) {
  ...
  return (displayedData !== null && displayedData !== void 0 ? displayedData : []).map((entry, index) => {
    ...
    return _objectSpread$a(_objectSpread$a(_objectSpread$a({}, entry), backgroundSector), {}, {
      payload: entry,
